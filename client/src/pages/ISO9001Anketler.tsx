...
function SurveyFormModal({ defaultSurvey, defaultQuestions, open, onOpenChange, surveyType }: {
  defaultSurvey?: Survey;
  defaultQuestions?: string;
  open: boolean;
  onOpenChange: (open: boolean) => void;
  surveyType: "musteri" | "calisanlar";
}) {
...
export default function ISO9001Anketler() {
  ...
  const surveyContent = isSurveysLoading ? (
  ...
  return (
    <div className="flex-1 flex flex-col space-y-4 p-4 md:p-8 pt-6 h-full overflow-auto">
      <div className="flex items-center justify-between">
        <h2 className="text-3xl font-bold tracking-tight">ISO 9001 Anketleri</h2>
